                  ...
                  Expanded(
                    child: widget.controller.isLoading
                        ...
                        : widget.controller.providers.isEmpty || selectedProvider == null
                            ? Center(
                                child: Text(
                                  'Todavía no cargaste proveedores. Creá uno para empezar a pedir y reponer.',
                                  style: TextStyle(
                                    fontSize: 12,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ProviderDetailPanel(
                                          ...
                                          suggestedItems: widget.controller.suggestedItems,
                                          draftUnits: widget.controller.draftUnits,
                                          draftTotal: widget.controller.draftTotal,
                                          suggestedUnits: widget.controller.suggestedUnits,
                                          ...
                                          onAbsorbSuggestions: widget.controller.absorbSuggestedItems,
                                          onClearSuggestions: widget.controller.clearSuggestedItems,
